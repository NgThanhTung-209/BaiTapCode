...
void searchSpeakerByTopic(const Speaker speakers[], int count) {
    if (count == 0) {
        cout << "No speakers available to search." << endl;
        return;
    }

    string keyword;
    cout << "Enter the topic keyword to search: ";
    cin.ignore();
    getline(cin, keyword);
    ...
    if (!found) {
        cout << "No speakers found with the topic containing: " << keyword << endl;
    }
}
void showMenu() {
    cout << "======================" << endl;
    ...
    do {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                break;
            case 4:
                searchSpeakerByTopic(speakers, count);
                break;
            case 5:
